...
export function Footer(){
  return (
    <footer className="w-full border-t bg-white py-6 md:py-12 lg:py-16 hidden md:block">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <Logo />
            <p className="text-sm text-gray-500">La première plateforme marocaine de désintermédiation immobilière.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/how-it-works" className="text-sm text-gray-500 hover:text-primary">
                  Comment ça marche
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-500">&copy; {new Date().getFullYear()} E-JAR. Tous droits réservés.</p>
